...
- **[AIP Identity](https://github.com/The-Nexus-Guard/aip/tree/main/mcp-server)** - Cryptographic agent identity for MCP. Ed25519 keypairs, DID-based verification, trust scoring via vouch chains, E2E encrypted messaging, and artifact signing. Install: `pip install aip-mcp-server`
