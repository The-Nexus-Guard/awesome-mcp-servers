...
- **[AIP Identity](https://github.com/The-Nexus-Guard/aip-mcp-server)** <a href="https://glama.ai/mcp/servers/The-Nexus-Guard/aip-mcp-server"><img height="20" src="https://glama.ai/mcp/servers/The-Nexus-Guard/aip-mcp-server/badge" alt="AIP Identity MCP server" /></a> - Cryptographic agent identity for MCP. Ed25519 keypairs, DID-based verification, trust scoring via vouch chains, E2E encrypted messaging, and artifact signing. Install: `pip install aip-mcp-server`
